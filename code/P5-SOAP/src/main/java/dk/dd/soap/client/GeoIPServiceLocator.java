...
public class GeoIPServiceLocator extends org.apache.axis.client.Service implements dk.dd.soap.client.GeoIPService {
 ...
 */
    ...
    public dk.dd.soap.client.GeoIPServiceSoap_PortType getGeoIPServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public dk.dd.soap.client.GeoIPServiceSoap_PortType getGeoIPServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            dk.dd.soap.client.GeoIPServiceSoap_BindingStub _stub = new dk.dd.soap.client.GeoIPServiceSoap_BindingStub(portAddress, this);
    ...
    public dk.dd.soap.client.GeoIPServiceSoap_PortType getGeoIPServiceSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public dk.dd.soap.client.GeoIPServiceSoap_PortType getGeoIPServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            dk.dd.soap.client.GeoIPServiceSoap12Stub _stub = new dk.dd.soap.client.GeoIPServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (dk.dd.soap.client.GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                dk.dd.soap.client.GeoIPServiceSoap_BindingStub _stub = new dk.dd.soap.client.GeoIPServiceSoap_BindingStub(new java.net.URL(GeoIPServiceSoap_address), this);
                _stub.setPortName(getGeoIPServiceSoapWSDDServiceName());
                return _stub;
            }
            if (dk.dd.soap.client.GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                dk.dd.soap.client.GeoIPServiceSoap12Stub _stub = new dk.dd.soap.client.GeoIPServiceSoap12Stub(new java.net.URL(GeoIPServiceSoap12_address), this);
                _stub.setPortName(getGeoIPServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
